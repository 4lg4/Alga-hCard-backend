! function(e) {
  if ("object" == typeof exports && "undefined" != typeof module) module.exports = e();
    ...
    var t;
    t = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this, t.hCard = e()
  }
}(function() {
  return function e(t, n, r) {
    ...
    1: [function(e, t, n) {
      ...
      t.exports = r, r.EventEmitter = r, r.prototype._events = void 0, r.prototype._maxListeners = void 0, r.defaultMaxListeners = 10, r.prototype.setMaxListeners = function(e) {
        ...
        if (i(n)) switch (arguments.length) {
          ...
          for (o = Array.prototype.slice.call(arguments, 1), u = n.slice(), r = u.length, l = 0; l < r; l++) u[l].apply(this, o);
        return !0
    ...
    5: [function(e, t, n) {
      ...
      function a() {
        _ && h && (_ = !1, h.length ? v = h.concat(v) : y = -1, v.length && l())
      }
      ...
      var o = e("../dispatcher/Dispatcher.js"),
        ...
        u = {
          ...
          blurField: function(e) {
            console.log("blurField"), s.default.dispatch({
    ...
    7: [function(e, t, n) {
      (function(t) {
        ...
        var a = function() {
          ...
          l = "undefined" != typeof window ? window.React : "undefined" != typeof t ? t.React : null,
          u = r(l),
          ...
          _ = function(e) {
            function t(e) {
              ...
              return f.default.setFields(e), n.state = {
                ...
                fetch("/update", {
                  method: "POST",
                  body: e + "=" + encodeURIComponent(f.default.fields[e].value),
                  headers: {
            ...
            return s(t, e), a(t, [{
              ...
              value: function() {
                return u.default.createElement("div", {
                  ...
                  className: "hcardForm col-md-6"
                }, u.default.createElement(p.default, {
                  fields: this.state.fields,
                  onBlur: this.onBlur
                })), u.default.createElement("div", {
                  className: "hcardPreview col-md-6"
        ...
        var a = function() {
          ...
          h = function(e) {
            function t(e, n) {
              ...
              return r.personalDetailsFields = ["givenName", "surname", "email", "phone"], r.addressFields = ["houseNumber", "street", "suburb", "state", "postcode", "country"], r.uploadAvatar = function(e) {
                var t = e.target;
                if (t.files && t.files[0]) {
                  var n = new FileReader;
                  n.onload = function(e) {
                    p.default.updateFields("avatar", e.target.result)
            ...
            return s(t, e), a(t, [{
              ...
              value: function() {
                return u.default.createElement("div", null, u.default.createElement("div", {
                  className: "title"
                }, "hCard Builder"), u.default.createElement("form", {
                  action: "/submit",
                  method: "post"
                }, u.default.createElement(f.default, {
                  fieldKeys: this.personalDetailsFields,
                  fields: this.props.fields,
                  onBlur: this.props.onBlur,
                  title: "Personal Details"
                }), u.default.createElement(f.default, {
                  fieldKeys: this.addressFields,
                  onBlur: this.props.onBlur,
                  fields: this.props.fields,
                  title: "Address"
                }), u.default.createElement("div", {
                  className: "hcardForm__section"
                }, u.default.createElement("div", {
                  className: "row"
                }, u.default.createElement("div", {
                  className: "col-md-6"
                }, u.default.createElement("span", {
                  className: "btn btn-xl btn-primary btn-file"
                }, "Upload Avatar ", u.default.createElement("input", {
                  ...
                  className: "btn btn-xl btn-primary btn-submit",
                  type: "submit"
                }, "Create hCard"))))))
              }
            }]), t
          }(u.default.Component);
        n.default = h, h.propTypes = {
            ...
            return s(t, e), a(t, [{
              ...
              value: function() {
                var e = this.props.fieldKeys[0],
                  t = this.props.fields[e].label,
                  n = this.props.fields[e].value,
                  r = this.props.fieldKeys[1],
                  i = this.props.fields[r].label,
                  o = this.props.fields[r].value;
                return u.default.createElement("div", {
                  className: "row"
                }, u.default.createElement("div", {
                  className: "col-md-6"
        ...
        var a = function() {
          ...
          d = function(e) {
            ...
            return s(t, e), a(t, [{
              key: "rows",
              value: function e(t) {
                for (var e = [], n = 0; n < t.length; n += 2) e.push(u.default.createElement(f.default, {
                  fieldKeys: t.slice(n, n + 2),
                  fields: this.props.fields,
                  onBlur: this.props.onBlur,
                  key: n / 2
                }));
              ...
              value: function() {
                return u.default.createElement("div", {
                  ...
                  className: "hcardForm__subtitle"
                }, this.props.title), this.rows(this.props.fieldKeys))
              }
            }]), t
          }(u.default.Component);
        n.default = d, d.propTypes = {
          ...
          d = function(e) {
            function t(e, n) {
              ...
              return r.state = {
                ...
                }), f.default.updateFields(r.props.field_id, e.target.value)
              }, r.onBlur = function(t) {
                console.log("onBlur"), e.onBlur(r.props.field_id)
              }, r
            }
            return s(t, e), a(t, [{
              key: "render",
              value: function() {
                return u.default.createElement("div", {
                  ...
                  className: "hcardForm__label",
                  htmlFor: this.props.field_id
                }, this.props.label), u.default.createElement("input", {
                  className: "form-control hcardForm__input",
                  name: this.props.field_id,
    ...
    12: [function(e, t, n) {
      (function(e) {
        ...
        var s = function() {
          ...
          a = "undefined" != typeof window ? window.React : "undefined" != typeof e ? e.React : null,
          l = t(a),
          u = function(e) {
            function t(e, n) {
            ...
            return o(t, e), s(t, [{
              key: "fullName",
              value: function() {
                return this.props.fields.givenName.value + " " + this.props.fields.surname.value
              }
            }, {
              key: "addressLineOne",
              value: function() {
                return this.props.fields.houseNumber.value + " " + this.props.fields.street.value
              }
            }, {
              key: "addressLineTwo",
              value: function() {
                return this.props.fields.suburb.value + ", " + this.props.fields.state.value
              }
            }, {
              key: "render",
              value: function() {
                ...
                }, "HCARD PREVIEW"), l.default.createElement("div", {
                  className: "float-reset"
                }), l.default.createElement("div", null, l.default.createElement("div", {
                  className: "preview__name"
                }, l.default.createElement("span", {
                  className: "preview__name__text"
                }, this.fullName())), l.default.createElement("img", {
                  className: "preview__photo",
                  src: this.props.fields.avatar.value
                }), l.default.createElement("div", {
                  className: "preview__details"
                }, l.default.createElement("div", {
                  className: "preview__details__row"
                }, l.default.createElement("span", {
                  className: "preview__descriptor"
                }, "Email"), l.default.createElement("span", {
                  className: "preview__content preview__content--left"
                }, this.props.fields.email.value)), l.default.createElement("div", {
                  className: "preview__details__row"
                }, l.default.createElement("span", {
                  className: "preview__descriptor"
                }, "Phone"), l.default.createElement("span", {
                  className: "preview__content preview__content--left"
                }, this.props.fields.phone.value)), l.default.createElement("div", {
                  className: "preview__details__row"
                }, l.default.createElement("span", {
                  className: "preview__descriptor"
                }, "Address"), l.default.createElement("span", {
                  className: "preview__content preview__content--left"
                }, this.addressLineOne())), l.default.createElement("div", {
                  className: "preview__details__row"
                }, l.default.createElement("span", {
                  className: "preview__descriptor"
                }, " "), l.default.createElement("span", {
                  className: "preview__content preview__content--left"
                }, this.addressLineTwo())), l.default.createElement("div", {
                  className: "preview__details__row"
                }, l.default.createElement("span", {
                  className: "preview__descriptor"
                }, "Postcode"), l.default.createElement("span", {
                  className: "preview__content preview__content--left"
                }, this.props.fields.postcode.value), l.default.createElement("span", {
                  className: "preview__descriptor preview__descriptor--right"
                }, "Country"), l.default.createElement("span", {
                  className: "preview__content preview__content--right"
                }, this.props.fields.country.value))))))
              }
            }]), t
          }(l.default.Component);
        n.default = u, u.propTypes = {
    ...
    15: [function(e, t, n) {
      ...
      var l = function() {
        ...
        _ = new v;
      n.default = _, d.default.register(function(e) {
        console.log("dispatcher", e, h.BLUR_FIELD), e.actions === h.UPDATE_FIELD ? (_.fields[e.field_id].value = e.value, _.emitChange()) : e.actions === h.BLUR_FIELD && (console.log("BLUR_FIELD"), _.emitBlur())
      })
    }, {
      ...
      var a = function() {
        ...
        d = function(e) {
          ...
          return s(t, e), a(t, [{
            ...
            key: "emitBlur",
            value: function() {
              console.log("emitBlur"), this.emit(f)
            }
          }, {
            ...
            key: "addBlurListener",
            value: function(e) {
              console.log("addBlurListener"), this.on(f, e)
            }
          }]), t
        }(u.default);
